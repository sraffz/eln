                ...
                <form method="POST" action="{{ route('register') }}" autocomplete="off">
                    ...
                    <div class="input-group mb-3">
                        <select name="jantina" id="jantina"
                            class="form-control {{ $errors->has('jantina') ? ' is-invalid' : '' }} select22"
                            required>
                    ...
                    <div class="input-group mb-3">
                        <select name="taraf" id="taraf" class="form-control {{ $errors->has('taraf') ? ' is-invalid' : '' }} select22" required>
                            <option value="">Pilih Taraf</option>
                            <option value="Tetap" {{ old('taraf') == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                            <option value="Jawatan Berasaskan Caruman (JBC)" {{ old('taraf') == 'Jawatan Berasaskan Caruman (JBC)' ? 'selected' : '' }}>Jawatan Berasaskan Caruman (JBC)
                            </option>
                            <option value="Sementara" {{ old('taraf') == 'Sementara' ? 'selected' : '' }}>Sementara</option>
                            <option value="Contract Of Service (COS)" {{ old('taraf') == 'Contract Of Service (COS)' ? 'selected' : '' }}>Contract Of Service (COS)</option>
