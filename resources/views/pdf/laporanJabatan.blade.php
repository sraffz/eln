...
<div class="container">
  ...
  <p align="center"><strong>LAPORAN JUMLAH MENGIKUT JABATAN PERJALANAN PEGAWAI AWAM KE LUAR NEGARA <BR>BAGI TAHUN {{$year}}</strong></p>            
  <table class="table">
    <thead>
      <tr>
    ...
    <tbody>
      <tr>
        <td class="text-center">BPSM</td>
        <td class="text-center">5</td>
      </tr>
      <tr>
        <td class="text-center">BPTM</td>
        <td class="text-center">6</td>
      </tr>
      <tr>
        <td class="text-center">UAD</td>
        <td class="text-center">2</td>
      </tr>
      <tr>
        <td class="text-center">UPEN</td>
        <td class="text-center">20</td>
      </tr>
      <tr>
        <td class="text-center">KT</td>
