...
<style>
    .page{
        ...
        padding-left:40px; 
        padding-right:40px;
        background-image: url({{ asset('public/adminlte/dist/img/kelantan.png')}});  
    }
</style>
            	...
            	<div class="col-xl-12">
                    <div class="row">
                        <div class="col-xl-12">
                        	...
                        	<br>
                        	<br>
                        	 &nbsp; &nbsp; &nbsp; &nbsp;<img src="{{ asset('public/adminlte/dist/img/kelantan.png')}}" width="200" height="150" alt="User Image"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        	<img src="{{ asset('public/img/logoeksa1.png')}}" width="130" height="130" alt="User Image"><br>
