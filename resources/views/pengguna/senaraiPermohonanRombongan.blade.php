                                    ...
                                    <tbody>
                                        @foreach ($rombongan as $index => $rombo)
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a
                                                        href="{{ url('detailPermohonanRombongan', [$id]) }}">{{ $rombo->negaraRom }}@if($rombo->negaraRom_lebih == 1){{ ', '.$rombo->negaraRom_tambahan }}@endif</a>
                                                    <br>
                                                    ({{ $rombo->codeRom }})
                                                </td>
                                                {{-- <td>{{ $rombo->codeRom }}</td> --}}
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($rombo->statusPermohonanRom == 'Permohonan Berjaya' or $rombo->statusPermohonanRom == 'Permohonan Gagal')
                                                        @if ($rombo->surat == 'MEMO')
                                                            <a href="{{ route('memo-rombongan', ['id' => $id]) }}"
                                                                class="btn btn-primary btn-xs">
                                                                Memo
                                                            </a>
                                                        @elseif ($rombo->surat == 'SURAT')
                                                            <a href="{{ route('surat-rombongan', ['id' => $id]) }}"
                                                                class="btn btn-primary btn-xs">
                                                                Surat
                                                            </a>
                                                        @endif
