@if ($detail->jenis_perjalanan == "Kenderaan Sendiri")
<div class="card card-{{ $tema }}" id="borang_kenderaan_sendiri">
@else
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01"  class="form-control" id="gaji" name="gaji" value="{{ old('gaji') }}" disabled
                    >
                    <small><i></i></small>
                </div>
                <!-- text input -->
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="type" class="form-control" name="jenis_kenderaan" value="{{ old('jenis_kenderaan') }}" id="jenis_kenderaan" disabled>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="type" class="form-control" name="kelas_perbatuan"
                        value="{{ old('kelas_perbatuan') }}" id="kelas_perbatuan" disabled>
                </div>
            </div>
        </div>
    </div>
