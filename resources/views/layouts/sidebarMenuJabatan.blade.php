        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('senaraiPermohonanLepas') }}">
                <i class="nav-icon  fas fa-list"></i>
                <P>Senarai Permohonan</P>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('senaraiPermohonanJabatan') }}">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('registerFormIndividu', 'rasmi') }}"><i
