...
Route::middleware(['auth'])->group(function () {
	Route::get('/', 'HomeController@home')->name('halamanUtama');
	...
	Route::prefix('luar_negara')->group(function () {
		...
		Route::get('/', 'permohonanController@index2')->name('halamanUtamaNegara');
		...
		Route::POST('daftarPermohonan/{id}', 'permohonanController@store')->name('negara.permohonan');
