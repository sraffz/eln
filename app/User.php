...
class User extends Authenticatable
{
    ...
    protected $fillable = ['nama','nokp','email','jawatan','gredKod','gredAngka','jabatan','jantina','password','role'];
    ...
    {
        $jumlah = \App\Permohonan::where('usersID', $this->usersID)
                        ->count();
    ...
    public function getJumlahPermohonanSemasaAttribute()
    {
        ...
        $jumlah_semasa = \App\Permohonan::where('usersID', $this->usersID)
    ...
    {
        $sideCountCetak =\App\Permohonan::with('user')
